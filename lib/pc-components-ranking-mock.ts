...
export const cpuRanking = ([
  ["cpu-001", "AMD", "Ryzen 7 7800X3D", "AMD Ryzen 7 7800X3D", "hang", 1, "游戏神U不是白叫的，装机区常年免喷答案。", ["游戏帧率强", "功耗温度舒服", "X3D口碑极高"], ["生产力不是最顶", "价格不算低"], ["游戏神U", "B站吹爆", "闭眼买"], 96, 92, 95, "positive", "recommend"],
